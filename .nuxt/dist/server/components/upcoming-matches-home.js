...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/UpcomingMatchesHome.vue?vue&type=template&id=6d01e23c
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
  ...
  }), _vm._ssrNode(" "), _vm._ssrNode("<div>", "</div>", [_c('CoolLightBox', {
    attrs: {
      "items": _vm.items,
      "index": _vm.index
    },
  ...
  }), _vm._ssrNode(" "), _vm._l(_vm.items, function (match, imageIndex) {
    return _vm._ssrNode("<div class=\"border-4 border-light-blue-500 rounded-4xl px-10 lg:px-16 py-8 mb-7.5 last:mb-0\">", "</div>", [_vm._ssrNode("<div class=\"grid md:grid-cols-12 grid-cols-1 items-center\">", "</div>", [_vm._ssrNode("<div class=\"md:col-start-1 md:col-end-7 flex flex-col md:justify-start md:items-start justify-center items-center text-center mr-5\">", "</div>", [_vm._ssrNode("<p class=\"sm:text-base text-sm font-medium\">" + _vm._ssrEscape(_vm._s(_vm.formatDate(match.date))) + "</p> "), _c('n-link', {
      staticClass: "transition-all text-2xl lg:text-4xl font-bold uppercase font-exo text-white mb-4 hover:text-primary",
      attrs: {
        "to": `/match/${match.slug}`
      }
    }, [_vm._v(" " + _vm._s(match.title) + " ")]), _vm._ssrNode(" <span class=\"text-primary font-normal text-sm font-exo\">" + _vm._ssrEscape(_vm._s(match.description)) + "</span>")], 2), _vm._ssrNode(" <div class=\"md:col-start-7 md:col-end-9 lg:mr-12 mr-5 md:my-auto my-8 flex flex-col items-center text-center\"><a href=\"#/\" class=\"lg:w-120 lg:h-120 w-88 h-88 bg-primary rounded-full block relative\"><img" + _vm._ssrAttr("src", `${match.playBtn}`) + _vm._ssrAttr("alt", match.playAlt) + " class=\"max-w-full h-auto w-auto absolute-center\"></a> <br> <span class=\"text-warning\">" + _vm._ssrEscape(_vm._s(match.stream)) + "</span></div> <div class=\"md:col-end-13 flex md:justify-end justify-center items-center w-full px-20 sm:px-0 sm:w-auto\"><img" + _vm._ssrAttr("src", match.teamOne) + " alt=\"Feature Icon\" class=\"lg:mr-9 mr-5\"> <img" + _vm._ssrAttr("src", match.teamVs) + " alt=\"Feature Icon\" class=\"lg:mr-9 mr-5\"> <img" + _vm._ssrAttr("src", match.teamTwo) + " alt=\"Feature Icon\"></div>")], 2)]);
  }), _vm._ssrNode(" " + _vm._ssrList(_vm.dateTime, function (match, imageIndex) {
    return "<li>" + _vm._ssrEscape(_vm._s(_vm.formatDate(match.date))) + "</li>";
  }))], 2), _vm._ssrNode(" " + (_vm.currentPage * _vm.maxPerPage < _vm.matchesData.length ? "<div class=\"flex justify-center mt-73\"><button class=\"primary-btn\" style=\"background-image:url(/images/others/btn-bg.webp);\">Other Features</button></div>" : "<!---->"))], 2)]);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./components/UpcomingMatchesHome.vue?vue&type=template&id=6d01e23c

// EXTERNAL MODULE: external "vue-cool-lightbox"
var external_vue_cool_lightbox_ = __webpack_require__(38);
...
var vue_cool_lightbox_min = __webpack_require__(46);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/UpcomingMatchesHome.vue?vue&type=script&lang=js




/* harmony default export */ var UpcomingMatchesHomevue_type_script_lang_js = ({
  components: {
  ...
  data() {
    return {
      ...
      text: "Тут вы можете ознакомиться с нашими последними новостями",
      index: null,
      currentPage: 3,
      maxPerPage: 1,
      showReadMore: true
  ...
  methods: {
    ...
    formatDate(date) {
      if (date) {
        return external_moment_default()(String(date)).format('YYYY-MM-DD - hh:mm A');
      }
    }
  }
});
// CONCATENATED MODULE: ./components/UpcomingMatchesHome.vue?vue&type=script&lang=js
 /* harmony default export */ var components_UpcomingMatchesHomevue_type_script_lang_js = (UpcomingMatchesHomevue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/UpcomingMatchesHome.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  components_UpcomingMatchesHomevue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var UpcomingMatchesHome = __webpack_exports__["default"] = (component.exports);
...
//# sourceMappingURL=upcoming-matches-home.js.map