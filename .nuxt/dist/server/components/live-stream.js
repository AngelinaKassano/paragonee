...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/LiveStream.vue?vue&type=template&id=5ab321ac
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('section', {
    staticClass: "live-section"
  }, [_vm._ssrNode("<div class=\"container relative\">", "</div>", [_c('CoolLightBox', {
    attrs: {
  ...
  }, _vm._l(_vm.matchesData, function (match, imageIndex) {
    return _c('swiper-slide', {
      ...
      staticClass: "md:w-120 w-20 h-20 md:h-120 cursor-pointer rounded",
      attrs: {
        "src": `${match.playBtnOne}`,
        "alt": match.playAlt
      }
    })]), _vm._v(" "), _c('div', {
      staticClass: "absolute md:h-20 h-12 left-1/2 bottom-0 transform -translate-x-2/4 bg-no-repeat bg-center w-full flex justify-center items-center",
      style: {
        backgroundImage: `url(${match.videoShapeBg})`
      }
    }, [_c('h3', {
      staticClass: "text-white font-exo font-bold uppercase text-base sm:text-xl md:text-2xl"
    }, [_vm._v(_vm._s(match.shapeTitle))])])])]);
  }), 1), _vm._ssrNode(" <div class=\"livesection-button-prev swipper-arrow text-white absolute top-2/4 transform -translate-y-2/4 md:w-68 w-55 md:h-55 h-11 bg-cover flex items-center justify-center hover:bg-arrow-hover-shape bg-arrow-shape transition-all 2xl:-left-28 left-3 z-50 cursor-pointer\"><img src=\"/images/icon/navigation-arrow2.webp\" alt class=\"w-4 h-6\"></div> <div class=\"livesection-button-next swipper-arrow text-white absolute top-2/4 transform -translate-y-2/4 md:w-68 w-55 md:h-55 h-11 flex items-center justify-center hover:bg-arrow-hover-shape bg-arrow-shape bg-cover transition-all 2xl:-right-28 2xl:left-auto right-3 z-50 cursor-pointer\"><img src=\"/images/icon/navigation-arrow1.webp\" alt class=\"w-4 h-6\"></div>")], 2)]);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./components/LiveStream.vue?vue&type=template&id=5ab321ac
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/LiveStream.vue?vue&type=script&lang=js





/* harmony default export */ var LiveStreamvue_type_script_lang_js = ({
  components: {
...
// CONCATENATED MODULE: ./components/LiveStream.vue?vue&type=script&lang=js
 /* harmony default export */ var components_LiveStreamvue_type_script_lang_js = (LiveStreamvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/LiveStream.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  components_LiveStreamvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var LiveStream = __webpack_exports__["default"] = (component.exports);
