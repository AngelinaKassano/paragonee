    ...
    <div>
        ...
        <div class="bg-gray-800 py-5">
            ...
            <div class="container flex justify-between relative items-center md:flex-row flex-col-reverse">
                ...
                <p class="text-gray-500 text-sm uppercase font-medium mb-0">© 2024  <i class="icofont-heart text-primary"></i>  <a href="https://millant.ru" class="transition-all hover:text-primary text-white">Millant</a></p>
